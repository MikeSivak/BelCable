    ...
    const industry = [
        {
            ...
            `,
            menu: [
                'Кабели контроля и передачи данных',
                'Кабели управления с ПЭ изоляцией в оболочке из ПBX пластика',
                'Кабели управления парной скрутки с полиэтиленовой изоляцией экранированные',
                'Кабели с медными жилами с пластмассовой изоляцией и оболочкой',
                'Кабели управления и передачи данных кУПД',
                'Кабели управления и передачи данных or- нестойкие, не распрастраняющие горение',
                'Кабели управления парной скрутки',
                'Кабели высокоскоростной передачи данных',
                'Кабели силовые не распространяющие горение и с низким дымо- газовыделением',
                'Кабели силовые огнестойкие',
                'Кабели с медными жиламис пластмассовой изоляцией и оболочкой',
                'Кабели силовые огнестойкие ине распространяющие горение,с изоляцией и оболочкой изполимерных компазиций, не содержащих галогенов',
                'Кабели силовые гибкие',
                'Кабели силовые гибкие для нестационарной прокладки',
                'Кабели контрольные',
